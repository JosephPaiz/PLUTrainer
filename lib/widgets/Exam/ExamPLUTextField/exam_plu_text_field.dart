...
class ExamPLUTextFieldBar extends StatefulWidget {
  final void Function(String) onPLUEntered;

  const ExamPLUTextFieldBar({
    super.key,
    required this.onPLUEntered,
  });

  @override
  State<ExamPLUTextFieldBar> createState() => _PLUTextFiedBarState();
}

class _PLUTextFiedBarState extends State<ExamPLUTextFieldBar> {
